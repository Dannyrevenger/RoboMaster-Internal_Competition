...
void StartServoTask01(void *argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of servo01 */
  servo01Handle = osThreadNew(StartServoTask01, NULL, &servo01_attributes);
...
/* USER CODE BEGIN Header_StartServoTask01 */
/**
  * @brief  Function implementing the servo01 thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartServoTask01 */
void StartServoTask01(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
  {
    ...
    osDelay(1000);
    // __HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_1, (uint16_t )750);
    // osDelay(1000);
